      ...
      <div className='relative flex flex-col gap-5 mb-10 items-center justify-center w-full'>
        ...
        <div className='flex flex-col sm:flex-col lg:flex-row justify-center items-center lg:items-stretch gap-5 w-[95%] lg:w-[70%] mx-auto' id='Projects'>
          ...
          <div className='flex flex-col mt-6 w-3/4 mx-auto md:w-full rounded-2xl projectBg text-white p-4 min-h-[400px] md:min-h-[300px] sm:p-4 md:p-4 lg:rounded-2xl flex-1 shadow-sm shadow-black transition delay-100 duration-300 ease-in-out hover:scale-102'>
            <div className='flex flex-col xl:flex-row justify-center items-center md:items-start gap-5 w-full px-4 md:gap-10 md:w-full'>
              <div className='md:w-full md:mx-auto md:justify-center md:items-center md:mt-5'>
                <img src='/Icons/hypertext.png' alt='Screenshot of HyperText Project' className='w-full lg:aspect-video object-contain bg-black/50 rounded-md outline outline-offset-1 outline-bg-white shadow-md'></img>
              </div>
              <div className='flex flex-col w-full justify-center items-center text-center md:w-full md:justify-center md:items-center md:text-center md:content-start secondText'>
                <div className='flex flex-row border-b-2 border-black pb-1 items-center gap-1 md:gap-5'>
                  <h2 className='sm:text-2xl text-xl font-bold'>Hyper Text Project</h2>

                  {/* Black github svg */}
                  <a href='https://github.com/thomas-stk/HyperText-Game' aria-label="View HyperText Project Source Code on GitHub" rel='noopener noreferrer' target='_blank'><svg className='-ml-1' width="35" height="56" viewBox="0 0 98 96" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className='flex flex-col mt-6 w-3/4 mx-auto md:w-full rounded-2xl projectBg text-white p-4 min-h-[400px] md:min-h-[300px] sm:p-4 md:p-4 lg:rounded-2xl flex-1 shadow-sm shadow-black transition delay-100 duration-300 ease-in-out hover:scale-102'>
            <div className='flex flex-col xl:flex-row justify-center items-center md:items-start gap-5 w-full px-4 md:gap-10 md:w-full'>
              <div className='md:w-full md:mx-auto md:justify-center md:items-center md:mt-5'>
                <img src='/Icons/vle.png' alt='Screenshot of Virtual Learning Environment Project' className='w-full lg:aspect-video object-contain bg-black/50 rounded-md outline outline-offset-1 outline-bg-white shadow-md'></img>
              </div>
              <div className='flex flex-col w-full justify-center items-center text-center md:w-full md:justify-center md:items-center md:text-center md:content-start secondText'>
                <div className='flex flex-row border-b-2 border-black pb-1 items-center gap-5'>
                  <h2 className='sm:text-2xl text-xl font-bold'>VLE Project</h2>

                  {/* Black github svg */}
                  <a href='https://github.com/thomas-stk/Database-project-VLE-React-App' aria-label="View VLE Project Source Code on GitHub" rel='noopener noreferrer' target='_blank'><svg className='-ml-1' width="35" height="56" viewBox="0 0 98 96" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_730_27126)">
                      <path d="M41.4395 69.3848C28.8066 67.8535 19.9062 58.7617 19.9062 46.9902C19.9062 42.2051 21.6289 37.0371 24.5 33.5918C23.2559 30.4336 23.4473 23.7344 24.8828 20.959C28.7109 20.4805 33.8789 22.4902 36.9414 25.2656C40.5781 24.1172 44.4062 23.543 49.0957 23.543C53.7852 23.543 57.6133 24.1172 61.0586 25.1699C64.0254 22.4902 69.2891 20.4805 73.1172 20.959C74.457 23.543 74.6484 30.2422 73.4043 33.4961C76.4668 37.1328 78.0937 42.0137 78.0937 46.9902C78.0937 58.7617 69.1934 67.6621 56.3691 69.2891C59.623 71.3945 61.8242 75.9883 61.8242 81.252L61.8242 91.2051C61.8242 94.0762 64.2168 95.7031 67.0879 94.5547C84.4102 87.9512 98 70.6289 98 49.1914C98 22.1074 75.9883 6.69539e-07 48.9043 4.309e-07C21.8203 1.92261e-07 -1.9479e-07 22.1074 -4.3343e-07 49.1914C-6.20631e-07 70.4375 13.4941 88.0469 31.6777 94.6504C34.2617 95.6074 36.75 93.8848 36.75 91.3008L36.75 83.6445C35.4102 84.2188 33.6875 84.6016 32.1562 84.6016C25.8398 84.6016 22.1074 81.1563 19.4277 74.7441C18.375 72.1602 17.2266 70.6289 15.0254 70.3418C13.877 70.2461 13.4941 69.7676 13.4941 69.1934C13.4941 68.0449 15.4082 67.1836 17.3223 67.1836C20.0977 67.1836 22.4902 68.9063 24.9785 72.4473C26.8926 75.2227 28.9023 76.4668 31.2949 76.4668C33.6875 76.4668 35.2187 75.6055 37.4199 73.4043C39.0469 71.7773 40.291 70.3418 41.4395 69.3848Z" fill="black" />
                    </g>
                    <defs>
        ...
        <div className='md:hidden flex flex-col w-full items-center'>
          ...
          <div className='mt-3'>
            <h3 className='font-semibold text-2xl text-white font-sans'>Thomas Stokes</h3>
            <p className='text-white font-sans text-xs'>Norwich, UK</p>
          </div>
          <div className='flex flex-row items-center space-x-4 mt-2'>

            {/* Github profile Link */}
            <a href='https://github.com/thomas-stk' aria-label="Visit Thomas Stokes' GitHub Profile" rel='noopener noreferrer' target='_blank'><svg width="37" height="56" viewBox="0 0 98 96" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Gmail link */}
            <a href="mailto:thomas.stk.7@gmail.com" aria-label="Email Thomas Stokes" rel='noopener noreferrer' target='_blank'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" width="45" height="56">
              <path d="M1.5 8.67v8.58a3 3 0 0 0 3 3h15a3 3 0 0 0 3-3V8.67l-8.928 5.493a3 3 0 0 1-3.144 0L1.5 8.67Z" />
              <path d="M22.5 6.908V6.75a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3v.158l9.714 5.978a1.5 1.5 0 0 0 1.572 0L22.5 6.908Z" />
            </svg></a>

            {/* LinkedIn link */}
            <a href="https://www.linkedin.com/in/thomas-stokes-912b043a8/" rel='noopener noreferrer' target='_blank'><img src="/inBug-White.png" alt="LinkedIn Icon" width="35" height="50"></img></a>

          </div>
        </div>
        {/* Text Section of the about section */}
        ...
        <div className='hidden md:mt-5 md:flex md:flex-row md:justify-evenly md:w-[95%] lg:w-[70%] md:mx-auto gap-12' id='About'>

          {/* Profile picture section for desktop*/}
          ...
          <div className='flex flex-col w-full items-center secondBg secondText md:mx-auto md:p-6 md:min-h-1/2 md:rounded-2xl'>
            <div className='flex flex-col items-center'>
